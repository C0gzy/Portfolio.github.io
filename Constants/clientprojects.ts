...
export const clientprojectsData: Project[] = [
    ...
    },
    {
        ...
        description: 
        "I interned at Torbridge Capital where I created multiple scripts in Python that automate email service with API endpoints which is projected to save 2+ hours every week. I learned a lot from the internship about making productionready and efficient code and how to create a program that suits the business’s needs.",
        media: [
