  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className={`rounded-2xl px-4 sm:px-6 lg:px-8 py-3 transition-all duration-500 
        ${ scrolled ? "bg-background/70 backdrop-blur-lg shadow-lg border border-accent/10" : "bg-transparent border border-transparent"}
        `}>
